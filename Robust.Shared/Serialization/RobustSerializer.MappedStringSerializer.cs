...
namespace Robust.Shared.Serialization
{
    ...
    public partial class RobustSerializer
    {
        ...
        public partial class MappedStringSerializer : ITypeSerializer, IStaticTypeSerializer
        {

            private static HashSet<INetChannel> IncompleteHandshakes = new HashSet<INetChannel>();
            ...
            private static void WriteStringPackage(Stream stream)
            {
                ...
                {
                    bytesWritten += WriteCompressedUnsignedInt(zs, (uint) MappedStrings.Count);
            ...
            private static IEnumerable<string> ReadStringPackage(Stream stream)
            {
                ...
                var c = ReadCompressedUnsignedInt(zs, out x);
                bytesRead += x;
                for (var i = 0; i < c; ++i)
                {
            ...
            private static string ConvertToBase64Url(byte[] data) => ConvertToBase64Url(Convert.ToBase64String(data));
            ...
            private static byte[] ConvertFromBase64Url(string s)
            {
                var l = s.Length % 3;
